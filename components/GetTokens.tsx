...
export const GetTokens = () => {
  return (
    <div className="align-center text-center flex flex-row h-8 my-4 align-middle justify-center">
      <GetTokensButton />
    </div>
  );
};
...
const GetTokensButton = () => {
  ...
  if (
    !userBalanceOnNetwork ||
    userBalanceOnNetwork?.value > minAmountRequired
  ) {
  ...
  if (
    !userBalanceOnMainnet ||
    userBalanceOnMainnet?.value < minAmountRequired * BigInt(5)
  ) {
