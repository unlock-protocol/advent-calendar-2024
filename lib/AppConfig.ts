export const AppConfig = {
  name: 'Unlock Advent Calendar 2024 🎁',
  description: `Join us as we take the wraps off the 2024 Unlock Protocol Advent Calendar (https://advent.unlock-protocol.com), an exciting journey through the world of Web3!
