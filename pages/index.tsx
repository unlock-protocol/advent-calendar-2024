        ...
        <div className="bg-[url('/images/background.svg')] bg-cover ">
          ...
          <main className='container relative flex-1 flex flex-col gap-4'>
            <div className='text-center text-white flex flex-col'>
              <h1
                className={`${meowScript.className} text-8xl bg-gradient-to-b text-transparent from-[#FCF6BA] to-[#BF953F] bg-clip-text `}
              >
                Advent Calendar
              </h1>
              <h2 className='text-3xl'>By Unlock, December 2024</h2>
              <p>
                One NFT a day, fun gifts, and some year-in-review highlights —
                just for you!
              </p>
            </div>
            <GetTokens />
          ...
          <footer className='flex-shrink-0 relative pt-16 text-center text-white font-semibold  w-full pb-16 flex flex-col'>
            <h3 className={`${meowScript.className} text-5xl`}>
